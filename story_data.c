...
StoryNode story[] = {
    ...
    [10] = {.description =
            ...
            .is_ending = false,
            .choice_texts = {"Gallop up to the first house you see\n",
    ...
    [14] = {.description =
            ...
            .next_nodes = {28, 29, 30}},
    [15] = {.description =
                "You walk towards the shimmering lake.\n As you approach, a "
    ...
    [16] =
        {.description =
             ...
             "The town square has a beautiful fountain in the center.\nYou see "
    ...
    [17] =
        {.description =
             ...
             "is amazing!\nAt the peak you see three different areas you could "
             "explore.\n",
         .is_ending = false,
    ...
    [18] = {.description =
                ...
                "beneath the surface.\nYou notice three interesting things.\n",
            .is_ending = false,
    ...
    [19] = {.description =
                ...
                "dinner!\nThey invite you down to join them. Their underground "
    ...
    [20] = {.description =
                ...
                "moles pops up.\nThey're not angry, just curious about you.\n",
            .is_ending = false,
    ...
    [21] =
        {.description =
             ...
             "filled with glowing flowers.\nThe flowers hum a gentle melody.\n",
         .is_ending = false,
         ...
         .next_nodes = {40, 41, 42}},
    [22] = {.description =
                "The colorful parrot introduces himself as Captain "
                "Feathers!\nHe's "
    ...
    [23] =
        {.description =
             ...
             "It's a shiny spinning top.\nThe bird wants to play with you.\n",
         .is_ending = false,
         ...
         .next_nodes = {46, 47, 48}},
    [24] = {.description =
                "The pink mom bird smiles warmly at you.\nShe looks wise and "
                "kind. "
    ...
    [26] =
        {.description =
             ...
             "sparkling water.\nA kind fairy named Orina appears before you!\n",
         .is_ending = false,
    ...
    [27] = {.description =
                ...
                "magical land!\nIt's beautiful! You spot interesting things "
                "below.\n",
            .is_ending = false,
    ...
    [29] = {.description =
                ...
                "crystals!\nThey sparkle in different colors. It's magical!\n",
            .is_ending = false,
    ...
    [31] =
        {.description =
             ...
             "door.\nShe gasps when she sees you! 'A baby unicorn!\nHow "
    ...
    [32] =
        {.description =
             "In the center of town, there's a big celebration!\nEveryone is "
         ...
         .next_nodes = {55, 56, 57}},
    [33] = {.description =
                "You approach the fountain.\nThe water sparkles with magical "
            ...
            .next_nodes = {40, 41, 42}},
    [34] = {.description =
                "Addy the axolotl smiles at your question.\n'Your horn is very "
    ...
    [36] =
        {.description =
             "You wave goodbye to Addy and head back towards town.\nAlong the "
         ...
         .next_nodes = {49, 50, 51}},
    [37] = {.description =
                "Mr. Leo Pard listens carefully to your story.\n'Ah yes, baby "
    ...
    [39] =
        {.description =
             "You feel scared and start to gallop away!\nBut Leo calls after "
    ...
    [40] =
        {.description =
             ...
             "with glowing flowers!\nYou pick one and it sparkles in your "
             "hand!\n",
         .is_ending = false,
    ...
    [41] =
        {.description =
             "You discover magical singing flowers nearby!\nYou sit and listen "
             "to their melody.\nThe song tells a story of ancient magic and "
             "hidden paths home.\n",
         .is_ending = false,
    ...
    [42] =
        {.description =
             "You find yourself in a beautiful meadow!\nYou dance joyfully and "
             "the flowers sway with you.\nTheir glow intensifies. You feel "
             "magical!\n",
         .is_ending = false,
    ...
    [43] =
        {.description =
             "You discover a wise old wizard sitting by a campfire!\nHe "
    ...
    [44] =
        {.description =
             "A helpful fairy appears before you in a shimmer of light!\n'I've "
    ...
    [45] =
        {.description =
             "You find a magical wishing well!\nIt glows with enchanted energy "
         ...
         .next_nodes = {64, 65, 66}},
    [46] = {.description =
                "You discover an enchanted grove with a magical talking "
                "tree!\nThe "
    ...
    [50] =
        {.description =
             "You discover a beautiful garden with a wise gardener!\nShe tends "
         ...
         .next_nodes = {61, 62, 63}},
    [51] = {.description =
                "You find a glowing portal archway!\nIt shimmers with rainbow "
    ...
    [52] =
        {.description =
             "Your new friend offers you magical refreshments!\nThe food and "
    ...
    [54] =
        {.description =
             "You say goodbye and continue on your journey.\nAs you walk, you "
         ...
         .next_nodes = {64, 65, 66}},
    [55] = {.description = "You meet kind and magical beings who greet you "
                           "warmly!\nThey seem "
            ...
            .next_nodes = {58, 59, 60}},
    [56] = {.description =
                "The magical beings listen carefully.\n'Ah yes, the way home,' "
    ...
    [57] =
        {.description =
             "You wave farewell and continue your adventure!\nThe path ahead "
    ...
    [58] =
        {.description =
             ...
             "leads straight home!\nYou step through and find yourself back in "
    ...
    [59] =
        {.description =
             ...
             "all the creatures talking!\nOrina appears and congratulates you. "
             "'You've proven yourself worthy,' she says, opening a portal "
             "home.\nYou thank her and step through. Success!\n",
         .is_ending = true,
         .choice_texts = {"", "", ""},
         .next_nodes = {0, 0, 0}},
    [60] =
        {.description =
             "The fairy accepts the flower with a huge smile!\n'This is the "
             "Flower of Kindness!' she exclaims.\n'You have a pure heart!' She "
             "grants your wish to go home.\nYou appear back in your own world, "
             "filled with joy!\n",
         .is_ending = true,
         .choice_texts = {"", "", ""},
         .next_nodes = {0, 0, 0}},
    ...
    [62] = {.description =
                ...
                "beautiful harmony!\nThe magic is so strong that it opens a "
                "portal "
    ...
    [63] =
        {.description =
             ...
             "need to say to return home!\nYou say 'Sparkle-Home-Sweet-Home!' "
    ...
    [64] =
        {.description =
             "You follow the trail with blue sparkles. The sparkles dance "
             "around you and form into a beautiful blue butterfly!\nThe "
             "butterfly invites you to dance. As you dance together, the "
             "butterfly's magic rubs off on you!\nYou gain the ability to fly! "
             "You soar through the sky and find your way back home!\n",
         .is_ending = true,
         .choice_texts = {"", "", ""},
         .next_nodes = {0, 0, 0}},
    [65] =
        {.description =
             "You bow gracefully and the magic around you responds!\nSuddenly, "
             "a beautiful shimmering doorway appears before you, glowing with "
             "golden and silver light!\nYou step through and find yourself back "
             "in your own world! You're home!\n",
         .is_ending = true,
         .choice_texts = {"", "", ""},
         .next_nodes = {0, 0, 0}},
    [66] =
        {.description =
             "You follow the trail with purple mist. The mist swirls around you "
             "and lifts you gently into the air!\nYou float through magical "
             "purple clouds that sparkle and shimmer.\nThe mist carries you "
             "safely home! You emerge from the purple mist back in your own "
             "world!\n",
         .is_ending = true,
         .choice_texts = {"", "", ""},
         .next_nodes = {0, 0, 0}},
    [67] =
        {.description =
             "The sleepy-time tea makes you very drowsy.\nYou yawn and curl up "
    ...
    [68] = {.description =
                ...
                "around you and you fall into a deep sleep.\nWhen you wake up, "
    ...
    [69] =
        {.description =
             "A mischievous sprite casts a sleeping spell on you for fun!\n"
             "'Sweet "
             "dreams!' it giggles.\nYou drift off to sleep and when you wake "
