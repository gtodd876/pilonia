...
StoryNode story[] = {
    ...
    [27] = {.description =
                ...
                "magical land! It's beautiful! You spot interesting things "
                "below.\n",
            .is_ending = false,
    ...
    [40] =
        {.description =
             ...
             "with glowing flowers! You pick one and it sparkles in your "
             "hand!\n",
         .is_ending = false,
    ...
    [42] =
        {.description =
             ...
             "the flowers sway with you. Their glow intensifies. You feel "
             "magical!\n",
         .is_ending = false,
